...
def create_table(list_of_peaks) -> (ndarray, int):
    ...
    if y_peaks_0 != cfg.Y0 or x_peaks_0 != cfg.X0:
        ...
        print(f'y_peaks_0 != cfg.Y0: {y_peaks_0}\t {cfg.Y0}')
        print(f'x_peaks_0 != cfg.X0: {x_peaks_0}\t {cfg.X0}')
        sys.exit(1)
    ...
    for n in range(table_rows):
        ...
        """
        Если двигаться против часовой стрелки, то точка "blue" 
        расположена после точки "red".
        """
